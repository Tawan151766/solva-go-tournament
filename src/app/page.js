...
export default function Home() {
  ...
  const tournaments = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=400&h=200&fit=crop&crop=center",
      logo: "https://images.unsplash.com/photo-1614294148960-9aa740632a87?w=60&h=60&fit=crop&crop=center",
      status: "completed",
      prize: "฿1,000,000",
    },
  ...
  const filteredTournaments = tournaments.filter((t) => {
    ...
    const locationMatch = t.location
      .toLowerCase()
    ...
    if (
      ...
      dateMatch =
        start.isAfter(filterStart.subtract(1, "day")) &&
        start.isBefore(filterEnd.add(1, "day"));
    }
      ...
      <Row justify="center" style={{ marginBottom: 32 }}>
        <Col xs={24} sm={22} md={18} lg={12} xl={10}>
          <Card className="valorant-card">
            <div
              className="valorant-card-header"
          ...
          <Col span={24} style={{ textAlign: "center" }}>
            <div className="valorant-card" style={{ padding: 48 }}>
              <TrophyOutlined
                style={{
                  fontSize: 48,
                  color: "var(--valorant-text-tertiary)",
                  marginBottom: 16,
                }}
              />
              <Text className="valorant-text-secondary">
                ไม่พบข้อมูลทัวร์นาเมนต์
              </Text>
            </div>
          </Col>
        ) : (
                    ...
                    <div style={{ position: "relative", height: 180 }}>
                      ...
                      <div
                        style={{
                          ...
                          bottom: 0,
                          background:
                            "linear-gradient(135deg, rgba(255, 70, 85, 0.1), rgba(0, 212, 170, 0.1))",
                        }}
                      />
                      <div
                        style={{
                      ...
                      >
                        {t.status === "upcoming" && (
                          <span
                            className="valorant-tag-warning"
                            style={{
                              padding: "4px 8px",
                              borderRadius: 4,
                              fontSize: 10,
                        ...
                        {t.status === "registration" && (
                          <span
                            className="valorant-tag-success"
                            style={{
                              padding: "4px 8px",
                              borderRadius: 4,
                              fontSize: 10,
                        ...
                        {t.status === "completed" && (
                          <span
                            className="valorant-tag-default"
                            style={{
                              padding: "4px 8px",
                              borderRadius: 4,
                              fontSize: 10,
                  ...
                  <div style={{ padding: "16px 0" }}>
                    ...
                    <div style={{ marginBottom: 12 }}>
                      ...
                      >
                        ...
                        {dayjs(t.endDate).format("DD MMM YYYY")}
                      </Text>
                    </div>
